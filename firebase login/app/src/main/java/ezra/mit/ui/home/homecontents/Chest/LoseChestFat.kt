...
@Composable
fun LoseChest(viewModel: AuthViewModel?, navController: NavHostController) {
    Box(
        ...
        Column() {
            ...
            Column(
                ...
                Text(text = "Cross Touch And Reach",
                    fontWeight = FontWeight.Bold,
                    fontSize = 20.sp)
                Text(text = "30 seconds")
                Divider()

                Text(text = "Alternating Hooks",
                    fontWeight = FontWeight.Bold,
                    fontSize = 20.sp)
                Text(text = "x20")
                Divider()

                Text(text = "Mountain Climber Squat Thrust",
                    fontWeight = FontWeight.Bold,
                    fontSize = 20.sp)
                Text(text = "x20")
                Divider()
                ...
                Text(text = "Downward Facing Dog On The Wall",
                    fontWeight = FontWeight.Bold,
                    fontSize = 20.sp)
                Text(text = "30 seconds")
                Divider()
...
@Composable
fun LoseChestPreviewLight() {
    AppTheme() {
        LoseChest(null, rememberNavController())
    }
