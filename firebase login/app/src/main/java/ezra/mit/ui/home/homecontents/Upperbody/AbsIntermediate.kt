...
@Composable
fun AbsIntermediate(viewModel: AuthViewModel?, navController: NavHostController) {
    Box(
        ...
        Column() {
            Box(
                ...
                Image(
                    painter = painterResource(R.drawable.abss),
...
@Composable
fun AbsIntermediatePreviewLight() {
    AppTheme() {
        AbsIntermediate(null, rememberNavController())
    }
