...
@Composable
fun BicepsTriceps(viewModel: AuthViewModel?, navController: NavHostController) {
    Box(
        ...
        Column() {
            Box(
                ...
                Text(
                    ...
                    color = Color.White,
                    text = "Biceps and Triceps".padStart(5),
            ...
            Column(
                ...
                Text(text = "Push Up Rotations",
                    fontWeight = FontWeight.Bold,
                    fontSize = 20.sp)
                Text(text = "x20")
                Divider()

                Text(text = "Inclined Tricep Dips",
                    fontWeight = FontWeight.Bold,
                    fontSize = 20.sp)
                Text(text = "x12")
                Divider()
                ...
                Text(text = "Arm Curl Crunch Left",
                    fontWeight = FontWeight.Bold,
                    fontSize = 20.sp)
                Text(text = "x14")
                Divider()

                Text(text = "Arm Curl Crunch Right",
                    fontWeight = FontWeight.Bold,
                    fontSize = 20.sp)
                Text(text = "x14")
                Divider()
...
@Composable
fun BicepsTricepsPreviewLight() {
    AppTheme() {
        BicepsTriceps(null, rememberNavController())
    }
