...
@Composable
fun ChestIntermediate(viewModel: AuthViewModel?, navController: NavHostController) {
    Box(
...
@Composable
fun ChestIntermediatePreviewLight() {
    AppTheme() {
        ChestIntermediate(null, rememberNavController())
    }
