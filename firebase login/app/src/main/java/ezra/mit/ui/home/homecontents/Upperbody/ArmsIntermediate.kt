...
@Composable
fun ArmsIntermediate(viewModel: AuthViewModel?, navController: NavHostController) {
    Box(
        ...
        Column() {
            ...
            Column(
                ...
                Text(text = "Skipping Without Rope",
                    fontWeight = FontWeight.Bold,
                    fontSize = 20.sp)
                Text(text = "30 seconds")
                Divider()
...
fun ArmsPreviewLight() {
    AppTheme() {
        ArmsIntermediate(null, rememberNavController())
    }
