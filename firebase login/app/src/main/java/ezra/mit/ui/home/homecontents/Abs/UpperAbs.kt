...
@Composable
fun UpperAbs(viewModel: AuthViewModel?, navController: NavHostController) {
    Box(
        ...
        Column() {
            Box(
                ...
                Text(
                    ...
                    color = Color.White,
                    text = "Upper Abs Workouts".padStart(5),
...
@Composable
fun UpperAbsPreviewLight() {
    AppTheme() {
        UpperAbs(null, rememberNavController())
    }
